...
IMAGE_CACHE_STORAGE = get('IMAGE_CACHE_STORAGE', 'image.storage.ManifestImageCacheStorage')
...
IMAGE_CACHE_HTTP_EXPIRATION = get('IMAGE_CACHE_HTTP_EXPIRATION', 3600 * 24 * 30 * 12)
